...
namespace SawMill.Data.Migrations
{
    ...
    [Migration("20200127054736_AlertPositon")]
    partial class AlertPositon
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SawMill.Data.Models.Correlation", b =>
                {
                    ...
                    b.Property<bool>("IsUserCorrelation");
            ...
            modelBuilder.Entity("SawMill.Data.Models.Alert", b =>
                {
                    b.HasOne("SawMill.Data.Models.AlertGroup", "AlertGroup")
                        ...
                        .HasConstraintName("FK_Alert_AlertGroup")
            ...
            modelBuilder.Entity("SawMill.Data.Models.Correlation", b =>
                {
                    b.HasOne("SawMill.Data.Models.System", "System")
                        ...
                        .HasForeignKey("SystemId")
                        .HasConstraintName("FK_Correlation_System");
                });
